      ...
      * ACUMULADORES
       ...
       01 A020-ACUM-BCO.
           05 A020-ACUM-CHEQUES-BCO       PIC S9(12)V99 .
       01 A030-ACUM-NO-CTA.
           05 A030-ACUM-CHEQUES-NO-CTA    PIC S9(12)V99 .
      ...
      *IMPRIME LA LINEA TOTAL POR NUMERO DE CUENTA
       ...
       01  R1-40-TOTAL-BCO.
           ...
           "T O T A L  B A N C O".
           05  FILLER                     PIC X(19)       VALUE SPACES.
           05  R1-40-TOTAL-BANCO          PIC ZZZ,ZZZ,ZZZ,ZZZ,ZZZ.99.
           05  FILLER                     PIC X(24)       VALUE SPACES.
       PROCEDURE DIVISION.
      *-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-
       000-CONTROL SECTION.
       ...
       010-0200-PROC-PTA.
           PERFORM 020-PROC-BCO
               UNTIL I010-ID-PROC-PTA NOT EQUAL TO I040-AI-ID-PTA.
...
*******               WRITE R1-REPORTESALIDA AFTER 2.
      *        ADD 2 TO R1-050-NUMLIN.
       ...
       020-PROC-BCO SECTION.
       030-0100-INICIO.
           MOVE I040-AI-ID-BCO TO I010-ID-PROC-BCO.
           MOVE R1-050-MAX-LIN TO R1-050-NUM-LIN.
           MOVE 0 TO A020-ACUM-CHEQUES-BCO.
       030-0200-PROC-BCO.
           PERFORM  030-PROC-NO-CTA
               UNTIL I010-ID-PROC-BCO NOT EQUAL TO I040-AI-ID-BCO.
       030-0300-ESCRIBE-BCO.
           MOVE A030-ACUM-NO-CTA TO R1-40-TOTAL-BANCO.
           IF (R1-050-NUM-LIN + 2)>R1-050-MAX-LIN THEN
               PERFORM 060-ENCABEZADOS
               END-IF.
           WRITE R1-REPORTE-SALIDA FROM R1-40-TOTAL-BCO AFTER 2.

           ADD 2 TO R1-050-NUM-LIN.


       030-0400-ESCRIBE-LINEAS.
       ...
       030-0500-ACTUALIZA-REGISTROS.
           ADD A020-ACUM-CHEQUES-BCO TO A010-ACUM-CHEQUES-PTA.
           ADD 1 TO A990-BCO-PROC.
       030-0990-TERMINA.
           EXIT.
           
           
       030-PROC-NO-CTA SECTION.
       030-0100-INICIO.
           MOVE I040-AI-ID-NO-CTA TO I010-ID-PROC-NO-CTA.
           MOVE 0 TO A030-ACUM-CHEQUES-NO-CTA.
       030-0200-PROC-NO-CTA.
           PERFORM  040-PROC-REG
               UNTIL I010-ID-PROC-NO-CTA NOT EQUAL TO I040-AI-ID-NO-CTA.
       030-0300-ESCRIBE-NO-CTA.
           MOVE A030-ACUM-NO-CTA TO R1-30-TOTAL-CUENTA.
           IF (R1-050-NUM-LIN + 2)>R1-050-MAX-LIN THEN
               PERFORM 060-ENCABEZADOS
               END-IF.
       ...
       030-0500-ACTUALIZA-REGISTROS.
           ADD A030-ACUM-CHEQUES-NO-CTA TO A020-ACUM-CHEQUES-BCO.
           ADD 1 TO A990-NO-CTA-PROC.
       030-0990-TERMINA.
           EXIT.

       040-PROC-REG SECTION.
       040-0100-INICIO.
      ...
      *     DISPLAY R1-030-PRINTVALORCHEQUE
       040-0200-ESCRIBE-REG.
           ...
           ADD RI-VALOR-CHEQUE TO A030-ACUM-CHEQUES-NO-CTA.
           PERFORM 050-LEE-REG.
           ADD 1 TO R1-050-NUM-LIN.
       040-0300-ACT-CIFRAS-DE-CONTROL.
